...
candidate_families <- g5_wfa_candidate_families(parse_character_list("GEN5_PCA_WFA_CANDIDATE_FAMILIES", "ema_cross,ema_trend,bollinger_touch,rsi_mr,zret_mr,breakout,pullback_in_uptrend,no_trade"))
