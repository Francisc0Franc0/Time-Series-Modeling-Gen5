...
async function main() {
...

  {
    const slide = deck.slides.add();
    slide.background.fill = "#FFFFFF";
    addTitle(slide, "The next build can fit a deliberately simple model");
    addText(slide, "ML-P0 passed the table-quality gate. The next useful slice is ML-P1: GLM logistic replay.", 92, 226, 760, 72, { fontSize: 30, color: "#000000", bold: true });
    addBullet(slide, "Fit only on TRAIN rows using frozen transforms.", 124, 350, 520);
    addBullet(slide, "Predict OOS h3 probability after each close.", 124, 420, 520);
    addBullet(slide, "Replay long/flat decisions with fixed or TRAIN-selected thresholds.", 124, 490, 520);
    addBullet(slide, "Compare probability traces, trade tapes, equity, and equal-weight basket hold.", 124, 560, 520);
