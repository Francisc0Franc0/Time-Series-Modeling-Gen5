...
output_dir <- file.path(repo_root, "runs", "research_workbench", "gen52_generalization", paste0("style_diversified_live_capital_", stamp))
...
for (spec in screen_specs) {
  ...
  query <- g5_workbench_query_adjusted_daily_bars(
    ...
    universe_name = paste0("gen52_style_div_", spec$screen_id),
  ...
  query_paths <- g5_write_workbench_query_artifacts(query, output_dir = query_dir, prefix = paste0("query_", spec$screen_id))
  bars <- query$bars
