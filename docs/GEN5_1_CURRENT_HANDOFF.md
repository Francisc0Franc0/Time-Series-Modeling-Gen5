...
- Gen5.3 is open as the PCA feature-layer diagnostics track, documented in `docs/GEN5_3_PCA_FEATURE_ALPHA_DIAGNOSTICS.md`, with deck `presentations/gen5_3_pca_feature_alpha_diagnostics_pivot.pptx`. The smoke packet `runs/research_workbench/g53/feat_smoke_20260708a/` suggested feature design matters, but the full follow-up packet `runs/research_workbench/g53/feat_full5w_20260709a/` did not support promoting any tested feature set. The follow-up ran `120` live-capital rows: three full five-name baskets, four feature sets, five OOS windows (`2020Q3`, `2021Q4`, `2022Q1`, `2022Q4`, `2024Q4`), and direct versus pooled-family selection under `state_switch_continuation`. Every feature/policy/basket aggregate lagged equal-weight live-basket hold. Best high-beta aggregate was control plus pooled-family (`-6.7 pp` mean alpha); best defensive was trend-volatility direct (`-3.6 pp`, but `0%` positive-alpha windows); best commodity was relative trend-volatility pooled (`-3.9 pp`). Pooled-family stayed less brittle than direct on average (`-6.6 pp` versus `-7.6 pp`) by trading less. The follow-up audit packet `runs/research_workbench/g53/feat_full5w_20260709a/feature_audit/` adds representative trade tapes, state-discrimination diagnostics, action-alignment diagnostics, and selected-family mix heatmaps. It suggests some feature sets, especially high-beta `trend_participation_plus`, may provide useful regime discrimination even though the action layer underused those states. Next narrow slice should diagnose state/action gating and upside underparticipation during strong benchmark quarters before adding more feature families or changing regime models.
