...
| `LIT-MOM-01.3` | Minimal SPY 250/25 Time-Series-Momentum Predictor | none | `FROZEN_OUTCOMES_NOT_OPEN`; direct causal predictor-target card only, sandbox and confirmation unread under this identifier |
