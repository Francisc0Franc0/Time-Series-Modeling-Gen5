...
| `LIT-MOM-01.2` | Single-Position Interday Time-Series Momentum | none | `RETROSPECTIVE_EXPLORATION_COMPLETE_LIT_MOM_01_2`; known 2021-2023 window, no confirmation authority |
...
| `LIT-MOM-01.2 / STOCK_ATLAS_01_RETROSPECTIVE` | The same frozen 22-stock panel; every stock searches all 49 TRAIN horizons independently and replays its own winner with one full-capital fixed-H position | `RETROSPECTIVE_EXPLORATION_COMPLETE_LIT_MOM_01_2_STOCK_ATLAS_01`; known 2021-2023 window, no winner-selection or confirmation authority |
...
| `LIT-MOM-01.2 / SHY_60_5_RETROSPECTIVE` | Same TRAIN-selected SHY signal with one fixed-quantity, fully compounded position held for exactly five open-to-open intervals | `RETROSPECTIVE_EXPLORATION_COMPLETE`; no fresh OOS authority |
