...
| `LIT-MOM-01.5` | Path-Quality Incremental Forecast Comparison | none | `FROZEN_IMPLEMENTATION_APPROVED_RESULTS_UNREAD`; drift versus raw return versus 24-cell path-quality forecast comparison, 2024-2025 confirmation sealed |
